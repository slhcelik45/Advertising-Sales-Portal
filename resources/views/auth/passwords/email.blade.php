...
<head>
    <meta charset="utf-8" />
    <link rel="shortcut icon" href="/admin/assets/pages/img/kanal23.png" />
    <title>Kanal 23 Reklam Paneli</title>
...
<!-- BEGIN LOGO -->
<div class="logo">
    <img src="/admin/assets/pages/img/kanal23.png" style="height: 100px;" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form method="POST" action="{{ route('password.email') }}" aria-label="{{ __('Reset Password') }}">
        @csrf
          ...
          <div class="form-group">
              <input class="form-control input-circle placeholder-no-fix" type="text" autocomplete="off" placeholder="E-mail Adresinizi Giriniz." name="email" /> </div>
          <div class="form-actions">
              <button type="submit" class="btn red-mint uppercase pull-right btn-circle">
                  <span class="glyphicon glyphicon-send"></span> Gönder</button>
              <a href="{{route('admin.index')}}" type="submit" class="btn grey-cascade btn-circle">
                   <span class="glyphicon glyphicon-backward"></span> Geri</a>
          </div>
