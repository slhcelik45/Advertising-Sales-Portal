                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark uppercase">Şirket Düzenle :{{$sirket->adi}}</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        {!! Form::model($sirket,['route'=>['sirketBilgileri.update',$sirket->id],'method'=>'PUT','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <img border="0" width="80" height="80" src="/{{$sirket->logo}}"
                                         style="float: left;margin: 20px 15px 15px 300px;"
                                    >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img border="0" width="80" height="80" src="/{{$sirket->yoneticifoto}}"
                                             style="float: left;margin: 20px 30px 30px 300px;"
                                        >
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="submit" class="btn blue btn-outline btn-circle"><span class="fa fa-refresh"></span> Güncelle</button>
                                    </div>
                                </div>
                            </div>
                            {!! Form::close() !!}
